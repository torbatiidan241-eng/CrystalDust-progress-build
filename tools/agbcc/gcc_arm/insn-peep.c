     ...
     rtx ins1;
{
  ...
  if (GET_CODE (x) != SET) goto L362;
  x = XEXP (pat, 0);
  if (!rtx_equal_p (operands[0], x)) goto L362;
  x = XEXP (pat, 1);
 ...
 L362:
  ...
  x = XEXP (pat, 0);
  operands[0] = x;
  if (! s_register_operand (x, QImode)) goto L363;
  x = XEXP (pat, 1);
  if (GET_CODE (x) != MEM) goto L363;
  if (GET_MODE (x) != QImode) goto L363;
  x = XEXP (XEXP (pat, 1), 0);
  operands[1] = x;
  ...
  if (GET_CODE (x) != SET) goto L363;
  x = XEXP (pat, 0);
  if (!rtx_equal_p (operands[1], x)) goto L363;
  x = XEXP (pat, 1);
  ...
  if (! (REGNO(operands[0]) != REGNO(operands[1])
   && (GET_CODE (operands[2]) != REG
       || REGNO(operands[0]) != REGNO (operands[2])))) goto L363;
  PATTERN (ins1) = gen_rtx_PARALLEL (VOIDmode, gen_rtvec_v (3, operands));
  INSN_CODE (ins1) = 363;
  delete_for_peephole (NEXT_INSN (ins1), insn);
  return NEXT_INSN (insn);
 L363:
  ...
  if (GET_CODE (x) != SET) goto L364;
  x = XEXP (pat, 0);
  if (!rtx_equal_p (operands[0], x)) goto L364;
  x = XEXP (pat, 1);
 ...
 L364:
  ...
  x = XEXP (pat, 0);
  operands[0] = x;
  if (! s_register_operand (x, HImode)) goto L365;
  x = XEXP (pat, 1);
  if (GET_CODE (x) != MEM) goto L365;
  if (GET_MODE (x) != HImode) goto L365;
  x = XEXP (XEXP (pat, 1), 0);
  operands[1] = x;
 ...
 L365:
  ...
  if (! (REGNO(operands[0]) != REGNO(operands[1])
   && (GET_CODE (operands[2]) != REG
       || REGNO(operands[0]) != REGNO (operands[2])))) goto L366;
  PATTERN (ins1) = gen_rtx_PARALLEL (VOIDmode, gen_rtvec_v (3, operands));
  INSN_CODE (ins1) = 366;
  delete_for_peephole (NEXT_INSN (ins1), insn);
  return NEXT_INSN (insn);
 L366:
  ...
  operands[1] = x;
  if (! index_operand (x, SImode)) goto L367;
  x = XEXP (pat, 1);
  operands[2] = x;
 ...
 L367:
  ...
  x = XEXP (pat, 0);
  if (GET_CODE (x) != MEM) goto L368;
  if (GET_MODE (x) != QImode) goto L368;
  x = XEXP (XEXP (pat, 0), 0);
  if (GET_CODE (x) != PLUS) goto L368;
  if (GET_MODE (x) != SImode) goto L368;
  x = XEXP (XEXP (XEXP (pat, 0), 0), 0);
  operands[4] = x;
  if (! shift_operator (x, SImode)) goto L368;
  x = XEXP (XEXP (XEXP (XEXP (pat, 0), 0), 0), 0);
  operands[0] = x;
  if (! s_register_operand (x, SImode)) goto L368;
  x = XEXP (XEXP (XEXP (XEXP (pat, 0), 0), 0), 1);
  operands[1] = x;
  if (! const_int_operand (x, SImode)) goto L368;
  x = XEXP (XEXP (XEXP (pat, 0), 0), 1);
  operands[2] = x;
  if (! s_register_operand (x, SImode)) goto L368;
  x = XEXP (pat, 1);
  operands[3] = x;
  if (! s_register_operand (x, QImode)) goto L368;
  do { insn = NEXT_INSN (insn);
       if (insn == 0) goto L368; }
  while (GET_CODE (insn) == NOTE
	 || (GET_CODE (insn) == INSN
  ...
  if (GET_CODE (x) != SET) goto L368;
  x = XEXP (pat, 0);
  if (!rtx_equal_p (operands[2], x)) goto L368;
  x = XEXP (pat, 1);
  if (GET_CODE (x) != PLUS) goto L368;
  if (GET_MODE (x) != SImode) goto L368;
  x = XEXP (XEXP (pat, 1), 0);
  if (GET_CODE (operands[4]) != GET_CODE (x)
      || GET_MODE (operands[4]) != GET_MODE (x)) goto L368;
  operands[4] = x;
  x = XEXP (XEXP (XEXP (pat, 1), 0), 0);
  if (!rtx_equal_p (operands[0], x)) goto L368;
 ...
 L368:
  ...
  if (GET_CODE (x) != SET) goto L369;
  x = XEXP (pat, 0);
  if (GET_CODE (x) != REG) goto L369;
  if (GET_MODE (x) != CCmode) goto L369;
  if (XINT (x, 0) != 24) goto L369;
  x = XEXP (pat, 1);
  if (GET_CODE (x) != COMPARE) goto L369;
  if (GET_MODE (x) != CCmode) goto L369;
  x = XEXP (XEXP (pat, 1), 0);
  if (!rtx_equal_p (operands[1], x)) goto L369;
  x = XEXP (XEXP (pat, 1), 1);
  if (GET_CODE (x) != CONST_INT) goto L369;
  if (XWINT (x, 0) != 0) goto L369;
 ...
 L369:
  ...
  operands[7] = x;
  if (! memory_operand (x, SImode)) goto L370;
  if (! (load_multiple_sequence (operands, 4, NULL, NULL, NULL))) goto L370;
 ...
 L370:
  ...
  operands[5] = x;
  if (! memory_operand (x, SImode)) goto L371;
  if (! (load_multiple_sequence (operands, 3, NULL, NULL, NULL))) goto L371;
 ...
 L371:
  ...
  operands[3] = x;
  if (! memory_operand (x, SImode)) goto L372;
  if (! (load_multiple_sequence (operands, 2, NULL, NULL, NULL))) goto L372;
 ...
 L372:
  ...
  operands[3] = x;
  if (! s_register_operand (x, SImode)) goto L373;
  if (! (store_multiple_sequence (operands, 4, NULL, NULL, NULL))) goto L373;
  PATTERN (ins1) = gen_rtx_PARALLEL (VOIDmode, gen_rtvec_v (8, operands));
  INSN_CODE (ins1) = 373;
  delete_for_peephole (NEXT_INSN (ins1), insn);
  return NEXT_INSN (insn);
 L373:
  ...
  operands[2] = x;
  if (! s_register_operand (x, SImode)) goto L374;
  if (! (store_multiple_sequence (operands, 3, NULL, NULL, NULL))) goto L374;
  PATTERN (ins1) = gen_rtx_PARALLEL (VOIDmode, gen_rtvec_v (6, operands));
  INSN_CODE (ins1) = 374;
  delete_for_peephole (NEXT_INSN (ins1), insn);
  return NEXT_INSN (insn);
 L374:
  ...
  pat = PATTERN (insn);
  x = pat;
  if (GET_CODE (x) != SET) goto L375;
  x = XEXP (pat, 0);
  operands[2] = x;
  if (! memory_operand (x, SImode)) goto L375;
  x = XEXP (pat, 1);
  operands[0] = x;
  if (! s_register_operand (x, SImode)) goto L375;
  do { insn = NEXT_INSN (insn);
       if (insn == 0) goto L375; }
  while (GET_CODE (insn) == NOTE
	 || (GET_CODE (insn) == INSN
  ...
  operands[1] = x;
  if (! s_register_operand (x, SImode)) goto L375;
  if (! (store_multiple_sequence (operands, 2, NULL, NULL, NULL))) goto L375;
  PATTERN (ins1) = gen_rtx_PARALLEL (VOIDmode, gen_rtvec_v (4, operands));
  INSN_CODE (ins1) = 375;
  delete_for_peephole (NEXT_INSN (ins1), insn);
  return NEXT_INSN (insn);
 L375:
  ...
  if (! ((GET_CODE (operands[0]) == SYMBOL_REF && USE_RETURN_INSN (FALSE)
    ...
    && !frame_pointer_needed && !current_function_args_size))) goto L376;
  PATTERN (ins1) = gen_rtx_PARALLEL (VOIDmode, gen_rtvec_v (2, operands));
  INSN_CODE (ins1) = 376;
  delete_for_peephole (NEXT_INSN (ins1), insn);
  return NEXT_INSN (insn);
 L376:
  ...
  if (! ((GET_CODE (operands[1]) == SYMBOL_REF && USE_RETURN_INSN (FALSE)
    && !get_frame_size () && !current_function_calls_alloca
    && !frame_pointer_needed && !current_function_args_size))) goto L377;
  PATTERN (ins1) = gen_rtx_PARALLEL (VOIDmode, gen_rtvec_v (3, operands));
  INSN_CODE (ins1) = 377;
  delete_for_peephole (NEXT_INSN (ins1), insn);
  return NEXT_INSN (insn);
 L377:
  ...
  pat = PATTERN (insn);
  x = pat;
  if (GET_CODE (x) != PARALLEL) goto L378;
  if (XVECLEN (x, 0) != 2) goto L378;
  x = XVECEXP (pat, 0, 0);
  if (GET_CODE (x) != SET) goto L378;
  x = XEXP (XVECEXP (pat, 0, 0), 0);
  operands[0] = x;
  if (! s_register_operand (x, VOIDmode)) goto L378;
  x = XEXP (XVECEXP (pat, 0, 0), 1);
  if (GET_CODE (x) != CALL) goto L378;
  x = XEXP (XEXP (XVECEXP (pat, 0, 0), 1), 0);
  if (GET_CODE (x) != MEM) goto L378;
  if (GET_MODE (x) != SImode) goto L378;
  x = XEXP (XEXP (XEXP (XVECEXP (pat, 0, 0), 1), 0), 0);
  operands[1] = x;
  x = XEXP (XEXP (XVECEXP (pat, 0, 0), 1), 1);
  operands[2] = x;
  if (! general_operand (x, SImode)) goto L378;
  x = XVECEXP (pat, 0, 1);
  if (GET_CODE (x) != CLOBBER) goto L378;
  x = XEXP (XVECEXP (pat, 0, 1), 0);
  if (GET_CODE (x) != REG) goto L378;
  if (GET_MODE (x) != SImode) goto L378;
  if (XINT (x, 0) != 14) goto L378;
  do { insn = NEXT_INSN (insn);
       if (insn == 0) goto L378; }
  while (GET_CODE (insn) == NOTE
	 || (GET_CODE (insn) == INSN
  ...
  pat = PATTERN (insn);
  x = pat;
  if (GET_CODE (x) != USE) goto L378;
  x = XEXP (pat, 0);
  if (!rtx_equal_p (operands[0], x)) goto L378;
  do { insn = NEXT_INSN (insn);
       if (insn == 0) goto L378; }
  while (GET_CODE (insn) == NOTE
	 || (GET_CODE (insn) == INSN
  ...
  pat = PATTERN (insn);
  x = pat;
  if (GET_CODE (x) != RETURN) goto L378;
  if (! ((GET_CODE (operands[1]) == SYMBOL_REF && USE_RETURN_INSN (FALSE)
    && !get_frame_size () && !current_function_calls_alloca
    && !frame_pointer_needed && !current_function_args_size))) goto L378;
  PATTERN (ins1) = gen_rtx_PARALLEL (VOIDmode, gen_rtvec_v (3, operands));
  INSN_CODE (ins1) = 378;
  delete_for_peephole (NEXT_INSN (ins1), insn);
  return NEXT_INSN (insn);
 L378:
  ...
  pat = PATTERN (insn);
  x = pat;
  if (GET_CODE (x) != PARALLEL) goto L379;
  if (XVECLEN (x, 0) != 2) goto L379;
  x = XVECEXP (pat, 0, 0);
  if (GET_CODE (x) != CALL) goto L379;
  x = XEXP (XVECEXP (pat, 0, 0), 0);
  if (GET_CODE (x) != MEM) goto L379;
  if (GET_MODE (x) != SImode) goto L379;
  x = XEXP (XEXP (XVECEXP (pat, 0, 0), 0), 0);
  operands[0] = x;
  x = XEXP (XVECEXP (pat, 0, 0), 1);
  operands[1] = x;
  if (! general_operand (x, SImode)) goto L379;
  x = XVECEXP (pat, 0, 1);
  if (GET_CODE (x) != CLOBBER) goto L379;
  x = XEXP (XVECEXP (pat, 0, 1), 0);
  if (GET_CODE (x) != REG) goto L379;
  if (GET_MODE (x) != SImode) goto L379;
  if (XINT (x, 0) != 14) goto L379;
  do { insn = NEXT_INSN (insn);
       if (insn == 0) goto L379; }
  while (GET_CODE (insn) == NOTE
	 || (GET_CODE (insn) == INSN
  ...
  pat = PATTERN (insn);
  x = pat;
  if (GET_CODE (x) != SET) goto L379;
  x = XEXP (pat, 0);
  if (GET_CODE (x) != PC) goto L379;
  x = XEXP (pat, 1);
  if (GET_CODE (x) != LABEL_REF) goto L379;
  x = XEXP (XEXP (pat, 1), 0);
  operands[2] = x;
  if (! (0 && GET_CODE (operands[0]) == SYMBOL_REF 
   && short_branch (INSN_UID (insn), INSN_UID (operands[2]))
   && arm_insn_not_targeted (insn))) goto L379;
  PATTERN (ins1) = gen_rtx_PARALLEL (VOIDmode, gen_rtvec_v (3, operands));
  INSN_CODE (ins1) = 379;
  delete_for_peephole (NEXT_INSN (ins1), insn);
  return NEXT_INSN (insn);
 L379:
  ...
  pat = PATTERN (insn);
  x = pat;
  if (GET_CODE (x) != PARALLEL) goto L380;
  if (XVECLEN (x, 0) != 2) goto L380;
  x = XVECEXP (pat, 0, 0);
  if (GET_CODE (x) != SET) goto L380;
  x = XEXP (XVECEXP (pat, 0, 0), 0);
  operands[0] = x;
  if (! s_register_operand (x, SImode)) goto L380;
  x = XEXP (XVECEXP (pat, 0, 0), 1);
  if (GET_CODE (x) != CALL) goto L380;
  x = XEXP (XEXP (XVECEXP (pat, 0, 0), 1), 0);
  if (GET_CODE (x) != MEM) goto L380;
  if (GET_MODE (x) != SImode) goto L380;
  x = XEXP (XEXP (XEXP (XVECEXP (pat, 0, 0), 1), 0), 0);
  operands[1] = x;
  x = XEXP (XEXP (XVECEXP (pat, 0, 0), 1), 1);
  operands[2] = x;
  if (! general_operand (x, SImode)) goto L380;
  x = XVECEXP (pat, 0, 1);
  if (GET_CODE (x) != CLOBBER) goto L380;
  x = XEXP (XVECEXP (pat, 0, 1), 0);
  if (GET_CODE (x) != REG) goto L380;
  if (GET_MODE (x) != SImode) goto L380;
  if (XINT (x, 0) != 14) goto L380;
  do { insn = NEXT_INSN (insn);
       if (insn == 0) goto L380; }
  while (GET_CODE (insn) == NOTE
	 || (GET_CODE (insn) == INSN
  ...
  if (GET_CODE (x) != SET) goto L380;
  x = XEXP (pat, 0);
  if (GET_CODE (x) != PC) goto L380;
  x = XEXP (pat, 1);
  if (GET_CODE (x) != LABEL_REF) goto L380;
  x = XEXP (XEXP (pat, 1), 0);
  operands[3] = x;
  if (! (0 && GET_CODE (operands[0]) == SYMBOL_REF
   && short_branch (INSN_UID (insn), INSN_UID (operands[3]))
   && arm_insn_not_targeted (insn))) goto L380;
  PATTERN (ins1) = gen_rtx_PARALLEL (VOIDmode, gen_rtvec_v (4, operands));
  INSN_CODE (ins1) = 380;
  delete_for_peephole (NEXT_INSN (ins1), insn);
  return NEXT_INSN (insn);
