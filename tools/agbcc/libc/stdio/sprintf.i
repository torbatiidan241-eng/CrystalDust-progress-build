...
# 289 "stdio/sprintf.c" 2

int

_sprintf_r(struct _reent *ptr , char *str , const char *fmt , ...)
...

{
  ...
  (ap = ((__gnuc_va_list) __builtin_next_arg(fmt)));
