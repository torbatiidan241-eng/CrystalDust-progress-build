...
# 121 "stdio/freopen.c"
  ...
  if (((fp)->_lb._base != ((void *)0)))
    { _free_r(fp->_data,(char *)(fp)->_lb._base); (fp)->_lb._base = ((void *)0); };
  fp->_lb._size = 0;
