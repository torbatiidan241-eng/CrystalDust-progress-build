...

{
  ...
  if ((mode != 0 && mode != 1 && mode != 2) || (int)(long) size < 0)
    return ((-1));
# 123 "stdio/setvbuf.c"
  (void) fflush (fp);
  fp->_r = 0;
  ...
  fp->_flags &= ~(0x0001 | 0x0002 | 0x0080);
...
# 163 "stdio/setvbuf.c"
  ...
  if (fp->_flags & 0x0008)
    fp->_w = fp->_flags & (0x0001 | 0x0002) ? 0 : size;
