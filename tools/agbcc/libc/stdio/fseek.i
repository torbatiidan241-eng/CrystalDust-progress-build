     ...
     int whence;
{
 ...
 {
   curoff = (*seekfn) (fp->_cookie, (fpos_t) 0, 1);
   if (curoff == -1L)
     return (-1);
 }
      if (fp->_flags & 0x0004)
...
# 255 "stdio/fseek.c"
  if ((fp->_flags & 0x2000) == 0 &&
      target >= curoff && target < curoff + n)
    {
      ...
      fp->_r = n - o;
      if (((fp)->_ub._base != ((void *)0)))
 { if ((fp)->_ub._base != (fp)->_ubuf) _free_r(fp->_data, (char *)(fp)->_ub._base); (fp)->_ub._base = ((void *)0); };
      fp->_flags &= ~0x0020;
      return 0;
    }
# 277 "stdio/fseek.c"
  curoff = target & ~(fp->_blksize - 1);
  if ((*seekfn) (fp->_cookie, curoff, 0) == (-(fpos_t)1))
    goto dumb;
  fp->_r = 0;
  if (((fp)->_ub._base != ((void *)0)))
    { if ((fp)->_ub._base != (fp)->_ubuf) _free_r(fp->_data, (char *)(fp)->_ub._base); (fp)->_ub._base = ((void *)0); };
...
dumb:
  if (fflush (fp) || (*seekfn) (fp->_cookie, offset, whence) == (-(fpos_t)1))
    return (-1);
