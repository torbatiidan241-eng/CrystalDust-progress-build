...
_putchar_r (ptr, c)
     ...
     int c;
{
  return (--(((ptr)->_stdout))->_w < 0 ? (((ptr)->_stdout))->_w >= (((ptr)->_stdout))->_lbfsize ? (*(((ptr)->_stdout))->_p = (c)), *(((ptr)->_stdout))->_p != '\n' ? (int)*(((ptr)->_stdout))->_p++ : __swbuf('\n', ((ptr)->_stdout)) : __swbuf((int)(c), ((ptr)->_stdout)) : (*(((ptr)->_stdout))->_p = (c), (int)*(((ptr)->_stdout))->_p++));
}
