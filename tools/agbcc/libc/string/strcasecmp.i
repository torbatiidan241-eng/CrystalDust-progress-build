# 0 "string/strcasecmp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "string/strcasecmp.c"
# 41 "string/strcasecmp.c"
...
{
  while (*s1 != '\0' && ({ int __x = (*s1); ((_ctype_+1)[(unsigned)(__x)]&01) ? (__x - 'A' + 'a') : __x;}) == ({ int __x = (*s2); ((_ctype_+1)[(unsigned)(__x)]&01) ? (__x - 'A' + 'a') : __x;}))
    {
      s1++;
      s2++;
    }
