# 0 "syscalls/sysopen.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "syscalls/sysopen.c"
...
open (const char *file, int flags, ...)
{
  ...
  (ap = ((__gnuc_va_list) __builtin_next_arg(flags)));



  ret = _open (file, flags, (ap = (__gnuc_va_list)((char *)(ap) + (((sizeof (int) + sizeof (int) - 1) / sizeof (int)) * sizeof (int))), *((int *)(void *)((char *)(ap) - (((sizeof (int) + sizeof (int) - 1) / sizeof (int)) * sizeof (int))))));
