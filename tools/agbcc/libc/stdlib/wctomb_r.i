...
# 3 "stdlib/wctomb_r.c" 2
# 1 "stdlib/mbctype.h" 1
# 10 "stdlib/mbctype.h"
int _issjis1 (int c);
int _issjis2 (int c);
int _iseucjp (int c);
int _isjis (int c);
# 4 "stdlib/wctomb_r.c" 2

int
_wctomb_r(struct _reent *r , char *s , wchar_t wchar , int *state)
      ...
      if (char1 != 0x00)
        {
          ...
          if (((char1) >= 0x81 && (char1) <= 0x9f || (char1) >= 0xe0 && (char1) <= 0xef) && ((char2) >= 0x40 && (char2) <= 0x7e || (char2) >= 0x80 && (char2) <= 0xfc))
            {
              *s++ = (char)char1;
              *s = (char)char2;
              return 2;
      ...
      if (char1 != 0x00)
        {
          ...
          if (((char1) >= 0xa1 && (char1) <= 0xfe) && ((char2) >= 0xa1 && (char2) <= 0xfe))
            {
              *s++ = (char)char1;
              *s = (char)char2;
              return 2;
      ...
      if (char1 != 0x00)
        {
          ...
          if (((char1) >= 0x21 && (char1) <= 0x7e) && ((char2) >= 0x21 && (char2) <= 0x7e))
            {
              if (*state == 0)
                {
