...
int _iseucjp (int c);
int _isjis (int c);
# 4 "stdlib/mbtowc_r.c" 2
# 48 "stdlib/mbtowc_r.c"
int
_mbtowc_r(struct _reent *r , wchar_t *pwc , const char *s , size_t n , int *state)
