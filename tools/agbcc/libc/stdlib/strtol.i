...
# 121 "stdlib/strtol.c" 2
# 1 "../ginclude/limits.h" 1
# 122 "stdlib/strtol.c" 2
# 1 "include/ctype.h" 1
...

{
 ...
 if (base == 0)
  base = c == '0' ? 8 : 10;
# 185 "stdlib/strtol.c"
 cutoff = neg ? -(unsigned long)(-2147483647L -1) : 2147483647L;
 ...
 if (any < 0) {
  acc = neg ? (-2147483647L -1) : 2147483647L;
  rptr->_errno = 34;
 } else if (neg)
  acc = -acc;
 if (endptr != 0)
