...
# 1595 "stdlib/mallocr.c"
extern mbinptr __malloc_av_[128 * 2 + 2];
# 1714 "stdlib/mallocr.c"
...

{
  ...
  if (alignment <= ((sizeof(size_t)) + (sizeof(size_t)))) return _malloc_r(reent_ptr, bytes);
  ...
  nb = (((long)((bytes) + ((sizeof(size_t)) + (((sizeof(size_t)) + (sizeof(size_t))) - 1))) < (long)((sizeof(struct malloc_chunk)) + (((sizeof(size_t)) + (sizeof(size_t))) - 1))) ? (((sizeof(struct malloc_chunk)) + (((sizeof(size_t)) + (sizeof(size_t))) - 1)) & ~((((sizeof(size_t)) + (sizeof(size_t))) - 1))) : (((bytes) + ((sizeof(size_t)) + (((sizeof(size_t)) + (sizeof(size_t))) - 1))) & ~((((sizeof(size_t)) + (sizeof(size_t))) - 1))));
...
# 3031 "stdlib/mallocr.c"
  ...
  remainder_size = ( (long)(((p)->size & ~((0x1|0x2))) - nb) );
